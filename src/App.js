  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
    <div className="bg-[#f4ecd8] border-4 border-[#4a3525] shadow-2xl max-w-lg w-full max-h-[85vh] flex flex-col">
      <div className="flex items-center justify-between p-5 border-b-2 border-[#8b694a] shrink-0">
        ...
        <button
          onClick={onClose}
          className="p-1 hover:bg-[#e8e0cc] rounded transition"
        >
      ...
      <div className="overflow-y-auto p-6 space-y-5 text-[#2c1e16] text-sm font-bold">
        <div>
          <h3 className="text-base font-black text-[#8b2500] mb-2 border-b border-[#8b694a] pb-1">
            🏛️ 게임 개요
          </h3>
          <p>
            아테네 시민 중 숨어있는 <span className="text-red-700">참주</span>를
            찾아 추방하는 추리 게임입니다.
          </p>
        </div>
        <div>
          <h3 className="text-lg font-black text-[#8b2500] mb-2 border-b border-[#8b694a] pb-1">
            📊 인원별 역할 배분
          </h3>
          <table className="w-full text-sm font-bold border-collapse">
            ...
            <tbody>
              {[
                ...
                <tr
                  key={n}
                  className="border-b border-[#8b694a] even:bg-[#e8e0cc]"
                >
        ...
        <div>
          <h3 className="text-lg font-black text-[#8b2500] mb-3 border-b border-[#8b694a] pb-1">
            👤 역할 설명
          </h3>
          <div className="space-y-3">
            <div className="p-3 bg-red-50 border-l-4 border-red-700">
              ...
              <p className="text-sm font-bold mt-1">
                밤마다 시민 1명을 추방하고, 시민 1명을 조력자로 포섭할 수
                있습니다.
              </p>
            </div>
        ...
        <div>
          ...
          <ol className="space-y-2 text-sm font-bold">
            <li className="flex gap-2">
              <span className="text-[#8b2500] font-black shrink-0">1.</span>{" "}
              방장이 게임을 시작하면 모든 참가자에게 역할이 비밀리에 배정됩니다.
            </li>
            <li className="flex gap-2">
              <span className="text-[#8b2500] font-black shrink-0">2.</span>
              <span>
                <span className="text-yellow-700">[낮]</span> 아고라에서
                자유롭게 토론하며 참주를 추리합니다.
              </span>
            </li>
            <li className="flex gap-2">
              <span className="text-[#8b2500] font-black shrink-0">3.</span>
              <span>
                <span className="text-orange-700">[투표]</span> 도편추방제로
                가장 의심스러운 사람에게 투표합니다. 최다 득표자가 추방됩니다.
                (동률 시 무효)
              </span>
            </li>
            <li className="flex gap-2">
              <span className="text-[#8b2500] font-black shrink-0">4.</span>
              <span>
                <span className="text-indigo-700">[밤]</span> 참주는 추방할
                시민과 포섭할 시민을 선택합니다. 페리클레스는 참주 의심자 2명을
                지목합니다.
              </span>
            </li>
            <li className="flex gap-2">
              <span className="text-[#8b2500] font-black shrink-0">5.</span>{" "}
              낮/투표/밤을 반복하며 승리 조건을 달성한 팀이 승리합니다.
            </li>
          </ol>
        </div>
        <div>
          ...
          <div className="space-y-2">
            <div className="p-3 bg-[#e8e0cc] border border-[#8b694a] flex gap-3 items-start">
              ...
              <div>
                <p className="font-black text-green-800">시민 승리</p>
                <p className="text-sm font-bold">
                  참주의 과반수(4명 중 3명 등)가 추방되면 시민이 승리합니다.
                </p>
              </div>
            </div>
            <div className="p-3 bg-[#e8e0cc] border border-[#8b694a] flex gap-3 items-start">
              <span className="text-2xl shrink-0">💀</span>
              <div>
                <p className="font-black text-red-800">참주 승리</p>
                <p className="text-sm font-bold">
                  참주+조력자의 수가 시민 수 이상이 되면 참주가 승리합니다.
                </p>
              </div>
            </div>
          </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm font-bold">
            <li className="flex gap-2">
              <span className="text-[#8b2500] shrink-0">•</span> 참주가
              페리클레스를 포섭하려 하면 참주의 정체가 전체 공개됩니다!
            </li>
            <li className="flex gap-2">
              <span className="text-[#8b2500] shrink-0">•</span> 페리클레스가
              지목한 사람은 노예 상태가 되어 투표권을 잃습니다.
            </li>
            <li className="flex gap-2">
              <span className="text-[#8b2500] shrink-0">•</span> 페리클레스가
              참주를 정확히 지목하면 모든 참주가 노예 상태가 되며 다음 밤 능력도
              봉쇄됩니다.
            </li>
            <li className="flex gap-2">
              <span className="text-[#8b2500] shrink-0">•</span> 페리클레스의
              조사 결과는 페리클레스 본인들만 게시판에서 볼 수 있습니다.
            </li>
          </ul>
        </div>
      </div>
      <div className="p-4 border-t-2 border-[#8b694a] shrink-0">
        <button
          onClick={onClose}
          className="w-full py-3 bg-[#8b2500] text-[#f4ecd8] font-black text-lg border-2 border-[#5c1800] shadow-[2px_2px_0px_#5c1800] hover:translate-y-[2px] hover:shadow-none transition-all"
        >
          규칙 확인 완료
        </button>
      </div>
...
export default function App() {
  ...
  const activePlayers = useMemo(
    () => playersArr.filter((p) => !p.isHost),
    [playersArr]
  );
  const alivePlayers = useMemo(
    () => activePlayers.filter((p) => p.isAlive),
    [activePlayers]
  );
  const me = roomData?.players?.[user?.uid];
  const amIHost = me?.isHost === true;
  const aliveEvil = useMemo(
    () => alivePlayers.filter((p) => p.role === "참주" || p.isHelper).length,
    [alivePlayers]
  );
  const aliveGood = alivePlayers.length - aliveEvil;
  const totalTyrants = useMemo(
    () => activePlayers.filter((p) => p.role === "참주").length,
    [activePlayers]
  );
  const deadTyrants = useMemo(
    () => activePlayers.filter((p) => p.role === "참주" && !p.isAlive).length,
    [activePlayers]
  );
  const tyrantNames = useMemo(
    () =>
      playersArr
        .filter((p) => p.role === "참주")
        .map((p) => p.name)
  ...
  const otherPericles = useMemo(() => {
    ...
    return (
      Object.values(roomData.players).find(
        (p) => p.role === "페리클레스" && p.id !== me.id && p.isAlive
      ) || null
    );
  }, [me, roomData?.players]);
  ...
  useEffect(() => {
    ...
    getDocs(getRoomsCol())
      .then((snap) => {
        ...
        snap.forEach((d) => {
          const data = d.data();
          if (data.phase === "setup" && data.createdAt < ago) {
            batch.delete(d.ref);
            n++;
          }
        });
  ...
  useEffect(() => {
    ...
    listUnsubRef.current = onSnapshot(
      ...
      (snap) => {
        ...
        snap.forEach((d) => {
          const data = d.data();
          if (data.phase === "setup") rooms.push(data);
        });
    ...
    return () => {
      if (listUnsubRef.current) listUnsubRef.current();
    };
  }, [user, screen]);
  ...
  const getPlayerName = useCallback(
    (id) => roomData?.players?.[id]?.name || "-",
    [roomData]
  );

  const canSeeLog = useCallback(
    (log) => {
  ...
  const getPericlesConsensus = useCallback((playersMap) => {
    const alive = Object.values(playersMap).filter(
      (p) => p.isAlive && !p.isHost
    );
    const human = alive.find((p) => p.role === "페리클레스" && !p.isBot);
    if (human)
      return { t1: human.nightTarget || "", t2: human.nightTarget2 || "" };
    const others = alive
      .filter((p) => p.role !== "페리클레스")
  ...
  const createRoom = useCallback(async () => {
    if (!user) return;
    if (expectedCount < 6)
      return setErrorMessage("최소 6명 이상의 인원을 설정해주세요.");
  ...
  const joinRoom = useCallback(
    async (targetCode) => {
      if (!user) return;
      const code = String(targetCode || roomCodeInput)
        .replace(/[^A-Za-z0-9]/g, "")
        .toUpperCase();
      ...
      try {
        ...
        if (!snap.exists())
          return setErrorMessage(`[${code}] 방을 찾을 수 없습니다.`);
        ...
        if (!existing && data.phase !== "setup") {
          const found = Object.entries(data.players).find(
            ([, p]) => p.name === myName && !p.isBot
          );
          if (found) {
            [oldUid, existing] = found;
          }
        }
        if (data.phase !== "setup" && !existing)
          return setErrorMessage(
            "이미 게임이 시작된 방입니다. 기존 이름으로 재접속해주세요."
          );

        if (oldUid && oldUid !== user.uid) {
          // 기존 UID → 현재 UID 이전 (batch)
          const batch = writeBatch(db);
          batch.update(getRoomRef(code), {
            [`players.${oldUid}`]: deleteField(),
          });
          batch.update(getRoomRef(code), {
            [`players.${user.uid}`]: { ...existing, id: user.uid },
          });
          await batch.commit();
        } else if (!existing) {
  ...
  const destroyRoom = useCallback(async () => {
    ...
    try {
      ...
      setErrorMessage("방 삭제 중 오류가 발생했습니다.");
    } finally {
      setIsProcessing(false);
    }
  ...
  const addBot = useCallback(async () => {
    ...
    const name =
      GREEK_NAMES[Math.floor(Math.random() * GREEK_NAMES.length)] + " (봇)";
    try {
  ...
  const simulateBotActions = useCallback(async () => {
    ...
    setIsProcessing(true);
    try {
      const alive = Object.values(roomData.players).filter(
        (p) => p.isAlive && !p.isHost
      );
      const nonTyrants = alive
        .filter((p) => p.role !== "참주")
        .sort(() => Math.random() - 0.5);
      ...
      const consensus =
        roomData.phase === "night"
          ? getPericlesConsensus(roomData.players)
          : null;
      const updates = {};
      Object.values(roomData.players).forEach((p) => {
        ...
        if (roomData.phase === "night") {
          if (p.role === "참주" && !roomData.nextNightTyrantBlocked) {
            ...
            if (commonHelp)
              updates[`players.${p.id}.nightTargetHelper`] = commonHelp;
  ...
  const startGame = useCallback(async () => {
    ...
    if (activePlayers.length < 6)
      return setErrorMessage("최소 6명이 필요합니다.");
    ...
    try {
      ...
      const updates = {
        ...
        logs: [
          mkLog(
            `🏛️ 민회 소집. 총 ${activePlayers.length}명. (참주 ${dist.참주}·페리클레스 ${dist.페리클레스}·시민 ${dist.시민})`,
            "system-info"
          ),
        ],
      };
  ...
  const startGameManual = useCallback(async () => {
    ...
    Object.values(manualRoles).forEach((r) => {
      if (r in dist) dist[r]++;
    });
    setIsProcessing(true);
    try {
      ...
      activePlayers.forEach((p) => {
        updates[`players.${p.id}.role`] = manualRoles[p.id];
      });
      await updateDoc(getRoomRef(currentRoomCode), updates);
  ...
  const openRoleAssignModal = useCallback(() => {
    ...
    const init = {};
    activePlayers.forEach((p) => {
      init[p.id] = p.role && p.role !== "관리자" ? p.role : "시민";
    });
    setManualRoles(init);
  ...
  const startNight = useCallback(async () => {
    ...
    const updates = {
      ...
      logs: trimLogs([
        ...roomData.logs,
        mkLog(
          `🌙 [제 ${newDay}일 밤] 참주와 페리클레스는 활동을 시작해주세요.`,
          "system-night"
        ),
      ]),
    };
  ...
  const startDay = useCallback(async () => {
    ...
    if (pList.length === 1) {
      const p = pList[0];
      const caught = [p.nightTarget, p.nightTarget2]
        .filter(Boolean)
        .filter((id) => pm[id]?.role === "참주");
      const t1n = pm[p.nightTarget]?.name || "(미선택)";
      const t2n = pm[p.nightTarget2]?.name || "(미선택)";
      if (caught.length) {
        all.forEach((q) => {
          if (q.role === "참주") pm[q.id].isSlave = true;
        });
        nextBlocked = true;
        logs.push(
          mkLog(
            `🔍 [조사] '${t1n}'·'${t2n}' 중 참주 발견! 참주: [${caught
              .map((id) => pm[id].name)
              .join(", ")}]. 모든 참주 노예 강등·능력 봉쇄.`,
            "pericles-secret",
            { visibleTo: pIds }
          )
        );
      } else {
        [p.nightTarget, p.nightTarget2].forEach((id) => {
          if (id && pm[id]) pm[id].isSlave = true;
        });
        logs.push(
          mkLog(
            `🔍 [조사] '${t1n}'·'${t2n}' 중 참주 없음. 지목자 투표권 박탈.`,
            "pericles-secret",
            { visibleTo: pIds }
          )
        );
      ...
      const agreed =
        p1.nightTarget &&
        p2.nightTarget &&
        p1.nightTarget === p2.nightTarget &&
        p1.nightTarget2 &&
        p2.nightTarget2 &&
        p1.nightTarget2 === p2.nightTarget2;
      if (!agreed) {
        logs.push(
          mkLog(
            "🔍 [조사] 두 페리클레스의 의견이 불일치하여 조사가 무효화되었습니다.",
            "pericles-secret",
            { visibleTo: pIds }
          )
        );
      } else {
        const caught = [p1.nightTarget, p1.nightTarget2]
          .filter(Boolean)
          .filter((id) => pm[id]?.role === "참주");
        ...
        if (caught.length) {
          ...
          [p1.nightTarget, p1.nightTarget2].forEach((id) => {
            if (id && pm[id]) pm[id].isSlave = true;
          });
          logs.push(
            mkLog(
    ...
    if (!roomData.nextNightTyrantBlocked) {
      const tyrants = all.filter((p) => p.role === "참주" && p.isAlive);
      ...
      if (tyrants.length > 1 && kills.length && !allKill)
        logs.push(
          mkLog(
            "참주들이 추방 대상을 합의하지 못했습니다. 추방 무효.",
            "pericles-secret",
            { visibleTo: tyrants.map((t) => t.id) }
          )
        );
    }
    ...
    if (helperId && pm[helperId]) {
      if (pm[helperId].role === "페리클레스") {
        const tNames = all
          .filter((p) => p.role === "참주" && p.isAlive)
          .map((p) => p.name)
          .join(", ");
        logs.push(
          mkLog(
            `🚨 참주가 페리클레스를 매수하려다 탄로! 참주: [${tNames}]`,
            "system-exile"
          )
        );
    ...
    if (killedId && pm[killedId]) {
      ...
      logs.push(
        mkLog(
          `어젯밤 ${pm[killedId].name}님이 참주에 의해 추방당했습니다.`,
          "system-kill"
        )
      );
    } else {
    ...
    if (win.isEnd)
      logs.push(
        mkLog(
          win.msg,
          win.winner === "citizen" ? "system-exile" : "system-kill"
        )
      );
  ...
  const endVoting = useCallback(async () => {
    ...
    if (!Object.keys(votes).length) {
      ...
      if (tie)
        logs.push(mkLog("동률표로 아무도 추방되지 않았습니다.", "normal"));
      else if (exiled && pm[exiled]) {
        pm[exiled] = { ...pm[exiled], isAlive: false };
        logs.push(
          mkLog(
            `${pm[exiled].name}님이 도편추방제로 추방됐습니다. 정체: [${pm[exiled].role}]`,
            "system-exile"
          )
        );
      }
  ...
  const handlePlayerAction = useCallback(
    async (type, targetId) => {
      ...
      try {
        await updateDoc(getRoomRef(currentRoomCode), {
          [fieldMap[type]]: targetId,
        });
      } catch {
        setErrorMessage("동작 전송에 실패했습니다.");
      }
    },
    [user, currentRoomCode]
  );
  ...
  if (screen === "home")
    return (
      <div
        className="min-h-screen flex items-center justify-center p-4 bg-[#e8e0cc] font-serif"
        style={{
          backgroundImage:
            "radial-gradient(circle at center,#f4ecd8 0%,#e8e0cc 60%,#d5c6aa 100%)",
        }}
      >
        <style
          dangerouslySetInnerHTML={{
            __html: `@import url('https://fonts.googleapis.com/css2?family=Noto+Serif+KR:wght@400;700;900&display=swap');.font-serif{font-family:'Noto Serif KR',serif;}`,
          }}
        />
        ...
        <div className="relative w-full max-w-md bg-[#f4ecd8] border-[10px] border-[#4a3525] p-2 shadow-2xl z-10">
          <div className="relative z-10 bg-[#f4ecd8] bg-opacity-95 p-8 border-2 border-[#8b694a] flex flex-col items-center shadow-inner text-center">
            <h2 className="text-sm font-bold text-[#8b2500] tracking-widest mb-2 mt-4">
              아테네의 민주정을 노리는 그림자
            </h2>
            <h1 className="text-4xl sm:text-5xl font-black text-[#2c1e16] tracking-tight mb-4 leading-tight">
              참주를 찾아라!
            </h1>
            <div className="w-12 h-1 bg-[#8b694a] mb-4" />
            <p className="text-[#4a3525] font-bold leading-relaxed mb-8">
              시민들이여, 합심하여
              <br />
              숨어있는 참주를 색출하라!
            </p>
            <div className="w-full mb-6 text-left">
              <label className="block text-sm font-bold text-[#4a3525] mb-2">
                당신의 이름은 무엇입니까?
              </label>
              <input
                type="text"
                className={`w-full p-4 bg-[#e8e0cc] border-2 focus:outline-none text-lg text-[#3e2b1d] ${
                  nameError
                    ? "border-red-600"
                    : "border-[#8b694a] focus:border-[#8b2500]"
                }`}
                placeholder="시민 이름 입력"
                value={myName}
                onChange={(e) => {
            ...
            <div className="w-full space-y-3">
              <button
                onClick={() => {
                  if (!myName.trim())
                    return setNameError("이름을 작성해주세요.");
  ...
  return (
    <div
      className={`min-h-screen transition-colors duration-500 font-serif ${
        isDark ? "bg-slate-900 text-gray-100" : "bg-[#e8e0cc] text-gray-900"
      } p-4 md:p-8 pb-20`}
    >
      <style
        dangerouslySetInnerHTML={{
      ...
      {showDestroyConfirm && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 p-4">
          <div className="bg-[#f4ecd8] border-4 border-red-800 p-6 max-w-sm w-full text-center shadow-2xl">
            ...
            <h3 className="text-xl font-bold text-[#4a3525] mb-2">
              방 폭파 경고
            </h3>
            <p className="text-[#2c1e16] font-bold mb-6">
              정말로 이 방을 폭파하시겠습니까?
            </p>
            <div className="flex gap-3">
              <button
                onClick={() => setShowDestroyConfirm(false)}
                className="flex-1 py-3 bg-gray-400 text-white font-bold border-2 border-gray-600"
              >
                취소
              </button>
              <button
                ...
                className="flex-1 py-3 bg-red-800 text-white font-bold border-2 border-red-900"
              >
      ...
      {errorMessage && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="bg-[#f4ecd8] border-4 border-[#8b2500] p-6 max-w-sm w-full text-center shadow-2xl">
            ...
            <p className="text-[#2c1e16] font-bold mb-6 break-keep">
              {errorMessage}
            </p>
            <button
              onClick={() => setErrorMessage("")}
              className="w-full py-3 bg-[#8b2500] text-[#f4ecd8] font-bold border-2 border-[#5c1800]"
            >
              확인
            </button>
          </div>
        ...
        <div className="flex items-center justify-center min-h-[80vh]">
          <div className="bg-[#f4ecd8] p-8 rounded-xl border-2 border-[#8b694a] shadow-xl max-w-md w-full">
            <h2 className="text-2xl font-black text-[#2c1e16] mb-6 flex items-center gap-2">
              <Users className="w-6 h-6 text-[#8b2500]" />
              아고라 개방
            </h2>
            <div className="mb-6">
              <label className="block text-sm font-bold text-[#4a3525] mb-2">
              ...
              <input
                type="number"
                className="w-full p-4 bg-[#e8e0cc] border-2 border-[#8b694a]"
                value={expectedCount}
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 py-4 bg-transparent border-2 border-[#4a3525] text-[#4a3525] font-bold"
              >
                뒤로
              </button>
              <button
                onClick={createRoom}
                disabled={isProcessing}
                className="w-2/3 py-4 bg-[#8b2500] text-[#f4ecd8] border-2 border-[#5c1800] font-bold"
              >
                {isProcessing ? (
        ...
        <div className="flex flex-col items-center justify-center min-h-[80vh] py-8">
          <div className="bg-[#f4ecd8] p-6 md:p-8 rounded-xl border-2 border-[#8b694a] shadow-xl max-w-lg w-full flex flex-col max-h-[90vh]">
            <h2 className="text-2xl font-black text-[#2c1e16] mb-6 flex items-center gap-2 shrink-0">
              <Key className="w-6 h-6 text-[#8b2500]" />
              민회 참석
            </h2>
              ...
              <div className="flex-1 overflow-y-auto pr-2 space-y-3">
                {availableRooms.length === 0 ? (
                  <div className="text-center py-10 bg-[#e8e0cc] border border-[#8b694a]">
                    <p className="font-bold text-[#4a3525]">
                      현재 대기 중인 방이 없습니다.
                    </p>
                  </div>
                ) : (
                  availableRooms.map((room) => (
                    <div
                      key={room.roomCode}
                      onClick={() => !isProcessing && joinRoom(room.roomCode)}
                    ...
                    >
                      <div>
                        <p className="font-black text-[#2c1e16] text-xl tracking-widest">
                          {room.roomCode}
                        </p>
                        <p className="text-sm text-[#4a3525] font-bold mt-1">
                          방장: {room.players[room.hostId]?.name || "?"}
                        </p>
                      </div>
                      <div className="text-right">
                        <span className="inline-block px-3 py-1 bg-[#8b2500] text-[#f4ecd8] text-xs font-bold rounded-sm mb-1">
                          {Object.keys(room.players).length}/
                          {room.expectedCount}명
                        </span>
                        <p className="text-xs font-bold text-[#8b694a]">
                          클릭하여 입장 →
                        </p>
                      </div>
                    </div>
            ...
            <button
              onClick={() => setScreen("home")}
              className="w-full py-4 bg-transparent border-2 border-[#4a3525] text-[#4a3525] font-bold shrink-0"
            >
              처음으로
            </button>
          </div>
        ...
        <div className="flex flex-col items-center">
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
              <div className="bg-[#f4ecd8] border-4 border-[#4a3525] shadow-2xl max-w-lg w-full max-h-[85vh] flex flex-col">
                <div className="flex items-center justify-between p-5 border-b-2 border-[#8b694a]">
                  <h2 className="text-xl font-black text-[#2c1e16]">
                    역할 직접 배정
                  </h2>
                  <button
                    onClick={() => setShowRoleAssign(false)}
                    className="p-1 hover:bg-[#e8e0cc] rounded"
                  >
                ...
                <div className="overflow-y-auto p-5 space-y-3 flex-1">
                  <div className="flex justify-between text-xs font-bold px-1 mb-2">
                    <span className="text-red-700">
                      참주:{" "}
                      {
                        Object.values(manualRoles).filter((r) => r === "참주")
                          .length
                      }
                      명
                    </span>
                    <span className="text-blue-700">
                      페리클레스:{" "}
                      {
                        Object.values(manualRoles).filter(
                          (r) => r === "페리클레스"
                        ).length
                      }
                      명
                    ...
                    <span className="text-green-700">
                      시민:{" "}
                      {
                        Object.values(manualRoles).filter((r) => r === "시민")
                          .length
                      }
                      명
                    </span>
                  ...
                  {activePlayers.map((p) => (
                    <div
                      key={p.id}
                      className="flex items-center justify-between bg-[#e8e0cc] p-3 border border-[#8b694a]"
                    >
                      ...
                      <div className="flex gap-2">
                        {["참주", "페리클레스", "시민"].map((role) => (
                          <button
                            ...
                            className={`px-3 py-1.5 text-xs font-black border-2 transition ${
                              manualRoles[p.id] === role
                                ? role === "참주"
                ...
                <div className="p-4 border-t-2 border-[#8b694a] flex gap-3">
                  ...
                  <button
                    ...
                    disabled={isProcessing}
                    className="w-2/3 py-3 bg-[#8b2500] text-[#f4ecd8] font-black border-2 border-[#5c1800]"
                  >
                    {isProcessing ? (
                      <Loader2 className="w-5 h-5 animate-spin mx-auto" />
                    ) : (
          ...
          <div className="w-full max-w-3xl bg-[#f4ecd8] p-6 md:p-10 border-2 border-[#8b694a] shadow-xl">
            <div className="text-center mb-10">
              <h2 className="text-3xl font-black text-[#2c1e16] mb-2">
                대기실
              </h2>
              ...
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-xl font-bold text-[#4a3525] flex items-center gap-2">
                  ...
                  <span className="text-[#8b2500]">
                    ...
                    {amIHost ? `/${roomData?.expectedCount}` : ""})
                  </span>
                </h3>
                {amIHost && (
                  <button
              ...
              <div className="bg-[#e8e0cc] p-4 border border-[#8b694a] min-h-[100px] shadow-inner">
                <div className="flex flex-wrap gap-2">
                  {activePlayers.length === 0 ? (
                    <span className="text-[#a68a6d] text-sm">
                      아직 참가자가 없습니다.
                    </span>
                  ) : (
                    activePlayers.map((p) => (
                      <div
                        ...
                        className={`px-4 py-2 font-bold text-sm border-2 ${
                          p.id === me?.id
                            ? "bg-[#8b2500] text-[#f4ecd8] border-[#5c1800]"
                            : p.isBot
              ...
              {amIHost ? (
                <>
                  ...
                  <button
                    ...
                    className="mt-2 text-red-800 text-sm font-bold hover:underline flex items-center gap-1"
                  >
                ...
                <div className="flex flex-col items-center gap-4 w-full">
                  <div className="p-6 bg-[#e8e0cc] border border-[#8b694a] w-full text-center">
                    <div className="animate-pulse text-[#8b2500] font-bold text-lg">
                  ...
                  <button
                    onClick={leaveRoom}
                    disabled={isProcessing}
                    className="mt-2 text-[#4a3525] text-sm font-bold hover:underline flex items-center gap-1"
                  >
      ...
      {screen === "role_reveal" && !amIHost && (
        <div className="flex items-center justify-center min-h-[80vh]">
          <div className="bg-[#2c1e16] p-10 border-4 border-[#8b694a] shadow-2xl max-w-md w-full text-center">
            <h2 className="text-2xl font-bold text-[#e8e0cc] mb-8">
              당신의 정체는...
            </h2>
            <div
              className={`py-12 px-6 mb-8 border-2 bg-[#f4ecd8] ${
                me?.role === "참주" ? "border-red-800" : "border-[#8b694a]"
              }`}
            >
              <h1
            ...
            <button
              ...
              className="w-full py-4 bg-[#8b694a] text-[#f4ecd8] font-bold text-lg"
            >
              확인 완료 (게임 입장)
            </button>
          </div>
      ...
      {screen === "game" && roomData && (
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
            {/* 게임 헤더 */}
            <div
              className={`p-6 border-2 shadow-lg flex items-center justify-between ${
                isDark
                  ? "bg-slate-800 border-slate-600 text-white"
                  : "bg-[#f4ecd8] border-[#8b694a]"
              }`}
            >
              <div>
                <h1 className="text-2xl font-black mb-1 flex items-center gap-2">
                  🏛️ 참주를 찾아라!
                  <span className="text-sm font-normal px-2 py-0.5 bg-black/10 rounded">
                ...
                <p className="text-sm font-bold opacity-70">
                  ...
                  {roomData.phase === "voting" &&
                    `제 ${roomData.dayCount}일 - 투표 중`}
                  {roomData.phase === "end" &&
                    `게임 종료 - ${
                      roomData.winner === "citizen" ? "시민" : "참주"
                    }의 승리`}
                </p>
              </div>
              {roomData.phase === "night" ? (
            ...
            {amIHost && (
              <div
                className={`p-5 shadow-md border-2 ${
                  isDark
                    ? "bg-slate-800/80 border-slate-600"
                    : "bg-[#e8e0cc] border-[#8b694a]"
                }`}
              >
                  ...
                  <div className="mb-4 p-3 bg-red-50 border border-red-800 rounded-sm">
                    ...
                    <div className="flex justify-between bg-white p-2 border border-red-200 text-sm font-black">
                      ...
                      <span className="text-orange-700">
                        참주 추방: {deadTyrants}/{totalTyrants}
                      </span>
                    </div>
                  </div>
                )}
                <div className="flex flex-wrap gap-2 mb-5">
                    ...
                    <>
                      {(roomData.phase === "setup" ||
                        ...
                        <>
                          <button
                            onClick={startVoting}
                            className="px-4 py-2 bg-red-800 text-[#f4ecd8] font-bold text-sm hover:bg-red-900 transition"
                          >
                            도편추방제 시작
                          </button>
                          <button
                            onClick={startNight}
                            className="px-4 py-2 bg-[#4a3525] text-[#f4ecd8] font-bold text-sm hover:bg-[#2c1e16] transition"
                          >
                            {roomData.phase === "setup"
                              ? "첫 번째 밤"
                              : "밤으로 변경"}
                      ...
                      {roomData.phase === "night" && (
                        <>
                          <button
                            ...
                            disabled={isProcessing}
                            className="px-4 py-2 bg-indigo-600 text-white font-bold text-sm hover:bg-indigo-700 transition flex items-center gap-1"
                          >
                            <Bot className="w-4 h-4" />봇 자동 행동
                          </button>
                          <button
                            onClick={startDay}
                            className="px-4 py-2 bg-[#8b2500] text-[#f4ecd8] font-bold text-sm hover:bg-red-800 transition"
                          >
                            낮으로 변경 (결과 적용)
                          </button>
                        </>
                      ...
                      {roomData.phase === "voting" && (
                        <>
                          ...
                          <button
                            onClick={endVoting}
                            className="px-4 py-2 bg-green-800 text-[#f4ecd8] font-bold text-sm hover:bg-green-900 transition"
                          >
                            투표 마감 및 결과 발표
                          </button>
                        </>
                  ...
                  <button
                    onClick={() => setShowDestroyConfirm(true)}
                    className="px-4 py-2 bg-gray-600 text-white font-bold text-sm ml-auto hover:bg-red-800 transition"
                  >
                    방 폭파
                  </button>
                </div>
                <div className="bg-white/60 p-4 rounded border border-[#8b694a]/30 overflow-x-auto">
                  <h3 className="font-bold mb-3 flex items-center gap-2 text-[#4a3525]">
                      ...
                      {activePlayers.map((p) => (
                        <tr
                          ...
                          className={`border-b border-black/10 ${
                            !p.isAlive ? "opacity-40 bg-gray-200" : ""
                          }`}
                        >
                          <td className="p-2 font-bold">
                            {p.name} {p.isBot && "🤖"}{" "}
                            {p.isHelper && (
                              <span className="text-xs text-purple-600 font-black">
                                (조력자)
                              </span>
                            )}
                          </td>
                              ...
                              !roomData.nextNightTyrantBlocked && (
                                <>
                                  <div className="text-red-600">
                                    추방: {getPlayerName(p.nightTarget)}
                                  </div>
                                  <div className="text-green-600">
                                    포섭: {getPlayerName(p.nightTargetHelper)}
                                  </div>
                                </>
                              )}
                            {roomData.phase === "night" &&
                            ...
                            {roomData.phase === "night" &&
                              ...
                              p.isAlive && (
                                <span className="text-blue-600">
                                  지목: {getPlayerName(p.nightTarget)},{" "}
                                  {getPlayerName(p.nightTarget2)}
                                </span>
                              )}
                            {roomData.phase === "voting" &&
                              p.isAlive &&
            ...
            >
              <div className="flex justify-between items-center mb-6 border-b border-black/10 pb-4">
                ...
                <div className="flex items-center gap-3">
                  <span
                    className={`px-4 py-1.5 font-black tracking-wide border-2 ${
                      amIHost
                  ...
                  {!amIHost && (
                    <button
                      ...
                      className={`p-1.5 border rounded transition ${
                        isDark
                          ? "bg-slate-700 hover:bg-red-900/50 text-gray-300 border-slate-500"
                          : "bg-white hover:bg-red-50 text-gray-600 hover:text-red-800 border-[#8b694a]/30"
                      }`}
                      title="방 나가기"
                    >
              ...
              {roomData.phase === "end" ? (
                <div className="text-center p-10 bg-gradient-to-br from-yellow-200 to-yellow-400 border-2 border-yellow-600">
                  ...
                  <p className="text-lg font-bold">
                    {roomData.winner === "citizen"
                      ? "아테네에 평화가 찾아왔습니다. 시민들의 승리입니다!"
                      : "참주가 아테네를 장악했습니다. 참주의 승리입니다!"}
                  </p>
                </div>
              ) : amIHost ? (
                <div className="text-center p-8 bg-[#e8e0cc] border-2 border-[#8b694a]">
                  <Shield className="w-16 h-16 text-[#8b694a] mx-auto mb-4" />
                  <h3 className="text-xl font-black mb-2 text-[#4a3525]">
                    관리자(방장) 시점입니다.
                  </h3>
                  <p className="text-sm font-bold opacity-80">
                    위의 게임 관리 패널로 진행해 주세요.
                  </p>
                </div>
              ) : !me?.isAlive ? (
                ...
                <div className="space-y-4">
                    ...
                    <div className="p-5 bg-purple-100 text-purple-900 border-2 border-purple-600 flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="font-bold text-sm mb-3">
                          이제{" "}
                          <span className="text-red-600">참주편(조력자)</span>
                          입니다.
                        </p>
                        <div className="bg-white/60 p-3 border border-purple-300 rounded-sm">
                          <span className="text-xs font-bold block mb-1 text-purple-800">
                            👑 참주 목록
                          </span>
                          <span className="font-black text-red-700 text-lg">
                            {tyrantNames}
                  ...
                  {me?.isSlave && roomData.phase !== "night" && (
                    <div className="p-5 bg-yellow-100 text-yellow-900 border-2 border-yellow-600 flex gap-4">
                      ...
                      <div>
                        <p className="font-bold text-lg">노예 상태입니다.</p>
                        <p>오늘 낮 투표권이 박탈됩니다.</p>
                      </div>
                    </div>
                  )}
                      ...
                      {me?.role === "참주" ? (
                        roomData.nextNightTyrantBlocked ? (
                          <div className="text-center py-8">
                            ...
                            <p className="font-black text-xl text-red-400 mb-2">
                              능력 봉쇄됨!
                            </p>
                            <p className="font-bold text-sm text-gray-300">
                              페리클레스에게 발각되어 오늘 밤 능력을 사용할 수
                              없습니다.
                            </p>
                          </div>
                        ) : (
                          <div className="space-y-4">
                            ...
                            <div>
                              <label className="block text-sm text-red-300 font-bold mb-1">
                                1. 추방시킬 시민
                              </label>
                              <select
                                className="w-full p-3 bg-slate-800 border border-slate-600 font-bold"
                                value={me.nightTarget || ""}
                                onChange={(e) =>
                                  handlePlayerAction(
                                    "night_kill",
                                    e.target.value
                            ...
                            <div>
                              <label className="block text-sm text-green-300 font-bold mb-1">
                                2. 포섭할 시민
                              </label>
                              <select
                                className="w-full p-3 bg-slate-800 border border-slate-600 font-bold"
                                value={me.nightTargetHelper || ""}
                                onChange={(e) =>
                                  handlePlayerAction(
                                    "night_help",
                                    e.target.value
                        ...
                        <div className="space-y-4">
                              ...
                              <p className="text-xs font-bold mb-2 flex items-center gap-1 text-blue-300">
                                {otherPericles.isBot ? (
                                  <>
                                    ...
                                    봇({otherPericles.name}) — 당신 선택 자동
                                    복사
                                  </>
                                ) : (
                                  <>
                                    <Shield className="w-3 h-3" />
                                    동료({otherPericles.name})의 현재 선택
                                  </>
                                )}
                              </p>
                              {!otherPericles.isBot && (
                                <div className="text-sm font-bold text-blue-200 flex gap-4">
                                  <span>
                                    1번:{" "}
                                    {getPlayerName(
                                      otherPericles.nightTarget
                                    ) !== "-" ? (
                                      getPlayerName(otherPericles.nightTarget)
                                    ) : (
                                      <span className="opacity-50">미선택</span>
                                    )}
                                  </span>
                                  <span>
                                    2번:{" "}
                                    {getPlayerName(
                                      otherPericles.nightTarget2
                                    ) !== "-" ? (
                                      getPlayerName(otherPericles.nightTarget2)
                                    ) : (
                                      <span className="opacity-50">미선택</span>
                                    )}
                                  </span>
                          ...
                          <select
                            ...
                            value={me.nightTarget || ""}
                            onChange={(e) =>
                              handlePlayerAction("night_peri_1", e.target.value)
                            }
                          >
                          ...
                          <select
                            className="w-full p-3 bg-slate-800 border border-slate-600 font-bold"
                            value={me.nightTarget2 || ""}
                            onChange={(e) =>
                              handlePlayerAction("night_peri_2", e.target.value)
                            }
                          >
                          ...
                          {otherPericles &&
                            ...
                            ((otherPericles.nightTarget &&
                              me.nightTarget &&
                              otherPericles.nightTarget !== me.nightTarget) ||
                              (otherPericles.nightTarget2 &&
                                me.nightTarget2 &&
                                otherPericles.nightTarget2 !==
                                  me.nightTarget2)) && (
                  ...
                  {roomData.phase === "voting" && !me?.isSlave && (
                    <div className="p-5 bg-[#e8e0cc] border-2 border-[#8b694a] shadow-inner">
                      ...
                      <select
                        className="w-full p-4 border-2 border-[#8b694a] bg-[#f4ecd8] font-bold"
                        value={me.voteTarget || ""}
                        onChange={(e) =>
                          handlePlayerAction("vote", e.target.value)
                        }
                      >
                        <option value="">
                          -- 추방할 사람 선택 (기권 가능) --
                  ...
                  {roomData.phase === "day" && (
                    <div className="text-center py-8 bg-black/5 rounded">
                      ...
                      <p className="font-bold text-lg">
                        낮 시간입니다. 아고라에서 토론을 진행하세요.
                      </p>
                    </div>
                  )}
                  {roomData.phase === "setup" && (
                    <p className="text-center py-8 font-bold text-lg opacity-70">
                      방장이 게임을 시작하기를 기다리고 있습니다.
                    </p>
                  )}
                </div>
          ...
          <div className="space-y-6">
            {/* 게시판 */}
            <div
              className={`p-5 border-2 shadow-lg h-[26rem] flex flex-col ${
                isDark
                  ? "bg-slate-800 border-slate-600"
                  : "bg-[#f4ecd8] border-[#8b694a]"
              }`}
            >
              <h3 className="font-black text-lg mb-4 border-b border-black/10 pb-3">
                📜 아고라 게시판
              </h3>
              <div className="flex-1 overflow-y-auto space-y-3 pr-2">
                {roomData.logs.length === 0 ? (
                  <p className="opacity-50 text-sm text-center mt-4">
                    새로운 소식이 없습니다.
                  </p>
                ) : (
                  roomData.logs.filter(canSeeLog).map((log) => (
                    <div
                      ...
                      className={`p-3 text-sm border ${
                        log.type === "system-night"
                          ? "bg-indigo-900 text-indigo-100 border-indigo-700"
                          : log.type === "system-kill"
                          ? "bg-red-100 text-red-900 border-red-800 font-bold"
                          : log.type === "system-vote"
                          ? "bg-orange-100 text-orange-900 border-orange-800 font-bold"
                          : log.type === "system-exile"
                          ? "bg-red-800 text-white border-red-900 font-black"
                          : log.type === "system-info"
                          ? "bg-[#4a3525] text-[#f4ecd8] border-[#2c1e16] font-bold"
                          : log.type === "pericles-secret"
                          ? "bg-blue-900 text-blue-100 border-blue-700 italic"
                          : "bg-[#e8e0cc] text-[#2c1e16] border-[#8b694a]"
                      }`}
                    >
                      <span className="text-xs opacity-60 block mb-1 font-mono">
                        {log.time}
                      </span>
                      {log.message}
                      {log.type === "pericles-secret" && (
                        <span className="block mt-1 text-xs text-blue-300 font-bold">
                          🔒 비공개 정보
                        </span>
                      )}
                    </div>
            ...
            {/* 명부 */}
            <div
              className={`p-5 border-2 shadow-lg max-h-[20rem] overflow-y-auto ${
                isDark
                  ? "bg-slate-800 border-slate-600"
                  : "bg-[#f4ecd8] border-[#8b694a]"
              }`}
            >
              <h3 className="font-black text-lg mb-4 border-b border-black/10 pb-3 flex justify-between items-center">
                👥 아테네 명부{" "}
                <span className="text-sm font-normal px-2 py-1 bg-black/10">
                ...
                {activePlayers.map((p) => (
                  <li
                    ...
                    className={`p-3 flex justify-between items-center border ${
                      !p.isAlive
                        ? "opacity-40 bg-black/10 border-transparent"
                        : "bg-[#e8e0cc] border-[#8b694a]"
                    }`}
                  >
                    <span
                      className={`font-bold ${
                        !p.isAlive ? "line-through" : ""
                      }`}
                    >
                      {p.name} {p.isBot && "🤖"}
                    </span>
